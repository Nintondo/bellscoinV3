...
For Ubuntu users, there is a new ppa maintained by Matt Corallo which you can add to your system so that it will automatically keep bitcoin up-to-date.  Just type "sudo apt-add-repository ppa:bitcoin/bitcoin" in your terminal, then install the bellscoin-qt package.
...
If you have a previously encrypted wallet.dat, the first time you run bellscoin-qt or bitcoind the wallet will be rewritten, Bitcoin will
