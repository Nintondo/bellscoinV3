...
- bitcoin/bitcoin#22230 Fix MSVC linker /SubSystem option for bellscoin-qt.exe (hebasto)
...
- bitcoin/bitcoin#21695 contrib: Remove no longer used contrib/bellscoin-qt.pro (hebasto)
