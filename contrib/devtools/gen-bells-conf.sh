...
BITCOIND=${BITCOIND:-$BINDIR/bellsd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/bells.conf}
...
then
  ...
  echo -e "To safely generate a bells.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example bells.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-bells-conf.sh.
##
