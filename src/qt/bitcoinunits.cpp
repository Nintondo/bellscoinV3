...
{
    switch (unit) {
    case Unit::BTC: return QString("BEL");
    case Unit::mBTC: return QString("mBEL");
    case Unit::uBTC: return QString::fromUtf8("µBEL (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Bells");
    case Unit::mBTC: return QString("Milli-Bells (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Bells (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
