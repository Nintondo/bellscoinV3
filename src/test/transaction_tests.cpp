...
BOOST_AUTO_TEST_CASE(tx_oversized)
{
    ...
    const auto oversizedTransactionBaseSize = ::GetSerializeSize(createTransaction(maxTransactionSize), PROTOCOL_VERSION | SERIALIZE_TRANSACTION_NO_WITNESS) - maxTransactionSize;
